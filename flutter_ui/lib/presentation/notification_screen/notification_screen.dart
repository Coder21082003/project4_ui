            ...
            body: Container(
                ...
                child: Column(children: [
                  _buildNotificationOption(context,
                      ...
                      feed: "Ưu đãi mới!", onTapNotificationOption: () {
                    onTapNotificationOption(context);
                  }),
                  _buildNotificationOption(context,
                      listIcon: ImageConstant.imgListIcon, feed: "Bảng tin"),
                  SizedBox(height: 5.v),
                  _buildNotificationOption(context,
                      listIcon: ImageConstant.imgNotificationIconPrimary,
                      feed: "Hoạt động", onTapNotificationOption: () {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        title: AppbarSubtitle(
            text: "Thông báo", margin: EdgeInsets.only(left: 12.h)));
  }
